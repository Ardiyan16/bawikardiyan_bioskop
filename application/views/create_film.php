...
<div class="container-fluid">
    ...
    <div class="card shadow py-2">
        <div class="card-body">
            ...
            <form action="<?= base_url('Bioskop/save_film'); ?>" method="POST" enctype="multipart/form-data">
                <label>Judul Film</label>
                <input name="judul_film" type="text" placeholder="Judul Film" class="form-control">
                <?= form_error('judul_film', '<small class="text-danger pl-3">', '</small>'); ?>
                <br>
                <label>Tanggal Launcing</label>
                <input name="tgl_launc" type="date" placeholder="Harga Satuan" class="form-control col-md-4">
                <?= form_error('tgl_launc', '<small class="text-danger pl-3">', '</small>'); ?>
                <br>
                <label>Sinopsis</label>
                <textarea id="summernote" name="synopys" rows="12"></textarea>
